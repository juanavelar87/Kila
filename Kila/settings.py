"""
Django settings for Kila project.
...
SECRET_KEY = 'django-insecure-cz0hs=klnw1+qp^@@9tntetg4!%3l%!7m_*-2jgcq6m^9za6es'
...
WSGI_APPLICATION = 'Kila.wsgi.application'
...
LOGIN_REDIRECT_URL ="/access/login"
